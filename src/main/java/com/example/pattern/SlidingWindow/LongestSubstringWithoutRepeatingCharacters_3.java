package com.example.pattern.SlidingWindow;
...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println(longestSubstringWithoutRepeatingCharacters3.lengthOfLongestSubstringSol4("abcdcdabef"));
//        System.out.println(longestSubstringWithoutRepeatingCharacters3.lengthOfLongestSubstringSol3("bbbbb"));
    }
}